        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <h5 class="text-xl font-bold leading-none text-gray-900 text-white">{{ Auth::user()->name }}
                    </h5>
                </div>
    ...
    <div class="col-span-2">
        <div class="bg-white rounded-lg shadow-lg p-6">
            @if ($tab === 'profile')
                ...
                <form class="max-w-sm mx-auto" action="{{ route('update.user.user', Auth::user()->id) }}" method="GET">
                    <div class="mb-5">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900">
                            Name</label>
                        <input type="text" name="name"
                            class="border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
                ...
                @foreach (Auth::user()->orders as $order)
                    <h2 id="accordion-collapse-heading-{{ $order->id }}">
                        <button type="button" wire:click="download({{ $order->id }})"
                            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4  focus:ring-gray-800 border-gray-700 text-gray-400"
            ...
            @elseif ($tab === 'addresses')
                ...
                <form class="max-w-sm mx-auto" action="{{ route('update.adress', Auth::user()->id) }}" method="GET">
                    <div class="mb-5">
