   ...
   <div>
       ...
       <div class="flex items-center mb-4">
           ...
           <span class="text-neutral-500">4.5 (24 reviews)</span>
       </div>

       <div class="mb-6">
           <div class="flex items-baseline">
               <span
                   class="text-2xl font-bold text-primary-600 ${hasDiscount ? 'text-accent-500' : ''}">{{ $product->price }}</span>
               <!--${hasDiscount ? `
                            <span class="ml-2 text-neutral-500 line-through">${formatPrice(product.price)}</span>
                            <span class="ml-2 bg-accent-500 text-white text-xs font-bold px-2 py-1 rounded">
           ...
           <p class="text-sm text-neutral-600 mt-1">
               <!--${product.stock > 0-->
               <!--?--> `<span class="text-forest-500 font-medium">In Stock</span> - {{ $product->stock }}
               units
               available`
           ...
           <div class="flex items-center mb-4">
               ...
               <div class="flex items-center">
                   <button id="decrease-quantity"
                       class="border border-neutral-300 rounded-l px-3 py-2 bg-neutral-100 hover:bg-neutral-200 transition-colors">
                   ...
                   <button id="increase-quantity"
                       class="border border-neutral-300 rounded-r px-3 py-2 bg-neutral-100 hover:bg-neutral-200 transition-colors">
                       <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24"
                           stroke="currentColor">
