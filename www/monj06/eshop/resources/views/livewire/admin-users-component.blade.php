<div id="accordion-collapse" data-accordion="collapse">
    @foreach ($users as $user)
        <h2 id="accordion-collapse-heading-{{ $user['id'] }}">
            <button type="button"
                ...
                data-accordion-target="#accordion-collapse-body-{{ $user['id'] }}" aria-expanded="true"
        ...
        <div id="accordion-collapse-body-{{ $user['id'] }}" class="hidden"
            aria-labelledby="accordion-collapse-heading-1">
            <form class="max-w-sm mx-auto" action="{{ route('update.user', $user['id']) }}" method="GET">
                <div class="mb-5">
                ...
                <div class="mb-5">
                    <label for="privilege" class="block mb-2 text-sm font-medium text-gray-900 text-white">
                        Privilege</label>
                    <select id="inputState" name="privilege" class="form-control">
                        <option value="0" {{ $user['privilege'] == 0 ? 'selected' : '' }}>0</option>
                        <option value="1" {{ $user['privilege'] == 1 ? 'selected' : '' }}>1</option>
                    </select>
                </div>
                <button type="submit"
    ...
    <!--<h2 id="accordion-collapse-heading-3">
        <button type="button"
            class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 focus:ring-gray-800 border-gray-700 text-gray-400 hover:bg-gray-100 hover:bg-gray-800 gap-3"
    ...
    <div id="accordion-collapse-body-3" class="hidden" aria-labelledby="accordion-collapse-heading-3">
        <div class="p-5 border border-t-0 border-gray-200 border-gray-700">
            <p class="mb-2 text-gray-500 text-gray-400">The main difference is that the core components from
                ...
                sections of pages.</p>
            <p class="mb-2 text-gray-500 text-gray-400">However, we actually recommend using both Flowbite,
            ...
            <ul class="ps-5 text-gray-500 list-disc text-gray-400">
                <li><a href="https://flowbite.com/pro/"
                        class="text-blue-600 text-blue-500 hover:underline">Flowbite Pro</a></li>
                <li><a href="https://tailwindui.com/" rel="nofollow"
                        class="text-blue-600 text-blue-500 hover:underline">Tailwind UI</a></li>
            </ul>
        </div>
    </div>-->
</div>
