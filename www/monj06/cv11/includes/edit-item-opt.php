...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if ($_SESSION['edited_at'] != $productsDB->findById($_GET['good_id'])[0]["edited_at"]) {
        $errors['conflict'] = "Product was eddited in the meantime.";
    }
    $_SESSION['edited_at'] = $productsDB->findById($_GET['good_id'])[0]["edited_at"];
