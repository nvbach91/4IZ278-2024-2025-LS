        ...
        <a class="dropdown-toggle d-flex align-items-center icon-link btn btn-secondary" href="#" role="button" data-bs-toggle="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                    ...
                    <a class="dropdown-item icon-link" href="{{ route('logout') }}"><i class="fa-solid fa-right-from-bracket"></i> Odhlásit se</a>
                </li>
            </ul>
        </li>
        @else
          <li class="nav-item">
            ...
            <a class="nav-link icon-link" href="{{ route('login') }}"> <i class="fa-solid fa-right-to-bracket"></i> Přihlášení</a>
          </li>
        @endif
      </ul>
    </div>
