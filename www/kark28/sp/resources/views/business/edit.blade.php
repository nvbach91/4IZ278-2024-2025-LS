                ...
                <div class="col-md-6 mb-4">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="existing-service border p-3 mb-3 position-relative">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <textarea name="services[{{ $index }}][description]" class="form-control" rows="2"
                                                {{ $hasReservations ? 'disabled' : '' }}>{{ $service->description }}</textarea>
                                        </div>
                                        ...
                                        @else
                                            <div class="text-danger small">Tuto službu nelze upravit – má existující
                                                rezervace.</div>
                                        @endif
                                    </div>
                                @endforeach
                            ...
                            <div class="mb-3">
                                <button type="button" class="btn btn-outline-primary w-100" id="add-service-btn">
                                    + Přidat novou službu
                                </button>
                            </div>
                    ...
                    @if ($editRole === 'owner')
                        <div class="card mt-4">
                            <div class="card-body">
                                ...
                                <ul class="list-group mb-3" id="manager-list" data-roles='@json($roles)'>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select form-select-sm" id="new-manager-role">
                                        @foreach ($roles as $value => $label)
                                            <option value="{{ $value }}">{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    <button type="button" class="btn btn-outline-primary" id="add-manager-btn">
                                        Přidat
                                    </button>
                                </div>
                            </div>
        ...
        <div class="existing-service border p-3 mb-3 position-relative">
          ...
          <button type="button"
            ...
            document.getElementById('add-manager-btn').addEventListener('click', function() {
                ...
                li.className =
                    'list-group-item d-flex justify-content-between align-items-center flex-wrap bg-light existing-manager';
                li.innerHTML = `
            <div class="flex-grow-1 me-2">
              <div class="mb-2">
                <label class="form-label mb-1">Email</label>
