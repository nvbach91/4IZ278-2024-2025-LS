        ...
        <div class="col-md-6">
            ...
            <?php if (isset($_SESSION['privilege']) && $_SESSION['privilege'] >= 2): ?>
                ...
                <a href="edit-item.php?id=<?= urlencode($product->good_id) ?>"
                    class="btn btn-warning">Upravit produkt optimisticky</a>
                <a href="edit-item-pessimistic.php?id=<?= urlencode($product->good_id) ?>"
                    class="btn btn-outline-warning mt-2">Upravit produkt pesimisticky</a>
