    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3">
                ...
                <?php if (isset($_SESSION['user_email'])&&$usersDB->checkUserPrivilege($_SESSION['user_email']) > 1): ?>
                <a class="nav-link" href="create-item.php">Create Item</a>
                <?php endif; ?>
                <?php if (isset($_SESSION['user_email'])&&$usersDB->checkUserPrivilege($_SESSION['user_email']) > 2): ?>
