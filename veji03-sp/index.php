    ...
    <aside class="sidebar">
        <form method="GET">
            <div class="filter-group">
                ...
                <select class="form-select" id="brand" name="brand">
                    ...
                    <?php foreach ($brands as $brand): ?>
                        <option value="<?= htmlspecialchars($brand['id']) ?>" <?= $brand['id'] == $filterBrand ? 'selected' : '' ?>>
            ...
            <div class="filter-group">
                ...
                <input type="number" name="max_price" id="max_price" class="form-control" value="<?= htmlspecialchars($filterMaxPrice) ?>" placeholder="Např. 10000">
            </div>
